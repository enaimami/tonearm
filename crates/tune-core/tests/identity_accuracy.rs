...
use tune_core::identity::{Candidate, ResolveMethod, Resolver, StaticLookup};
use tune_core::ids::{CanonicalId, Isrc, Mbid};
...
impl Case {
    ...
    fn is_satisfied_by(&self, resolution: &tune_core::identity::Resolution) -> bool {
