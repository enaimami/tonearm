...
impl Permissions {
    ...
    /// İnsan okunur özet. `tonearm plugin list` ve `tonearm diag` bunu basar.
    #[must_use]
...
pub struct PluginManifest {
    ...
    /// `tonearm provider list` ve arama yönlendirmesi eklentiyi başlatmadan
