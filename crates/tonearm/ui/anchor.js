...
//
// Bu dosya `tonearm_core::playback::anchor::PlaybackAnchor::position_at`'in
...
// doğruluk kaynağı. Rust tarafını `tonearm-core/tests/anchor_parity.rs`,
// bu tarafı `tonearm/tests/anchor_parity.mjs` bağlıyor.
//
