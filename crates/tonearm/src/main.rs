//! `tonearm` — çekirdeğin masaüstü kabuğu (PLAN Faz 3).
//!
...
//!
//! **D-030:** bağımlılık tek yönlü. Bu paket `tonearm-cli`'yi hiç görmez; biri
...
fn init_tracing() {
    let filter = tracing_subscriber::EnvFilter::try_from_default_env()
        .unwrap_or_else(|_| tracing_subscriber::EnvFilter::new("tonearm_core=warn,tonearm=warn"));
