...
use tonearm_core::playback::TickReport;
...
pub const TICK_EVENT: &str = "tonearm://tick";
...
pub const ERROR_EVENT: &str = "tonearm://error";
...
struct Notable {
    track: Option<tonearm_core::ids::CanonicalId>,
    state: tonearm_core::playback::PlayState,
    rate: f64,
    duration_ms: Option<u64>,
}

impl Notable {
    fn of(anchor: &tonearm_core::playback::PlaybackAnchor) -> Self {
        Self {
...
mod tests {
    ...
    use super::*;
    use tonearm_core::playback::{PlayState, PlaybackAnchor};
