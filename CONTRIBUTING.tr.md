...
> **Türkçe kopya.** Kanonik metin İngilizcedir: [`CONTRIBUTING.md`](CONTRIBUTING.md).
...
[`PLAN.tr.md`](PLAN.tr.md) ve [`DECISIONS.tr.md`](DECISIONS.tr.md) okunmalı — çoğu "neden
böyle yapılmamış?" sorusunun cevabı orada, gerekçesiyle duruyor.

## Önce oku

- [`PLAN.tr.md`](PLAN.tr.md) — yol haritası, değişmez kurallar (§2), faz sınırları,
  ASLA YAPMA, sözlük. **Kurallarda bu dosya geçerlidir.**
- [`CLAUDE.tr.md`](CLAUDE.tr.md) — workspace ağacı, komutlar, kod konvansiyonları,
  CLI test yüzeyi, tanılama pratiği. **Operasyonel bilgide bu dosya geçerlidir.**
- [`DECISIONS.tr.md`](DECISIONS.tr.md) — verilmiş kararlar ve gerekçeleri.
...
"atlandı" de. Bugün Linux'ta 466 test koşuyor ve 3'ü kendini atlıyor
...
Tam metin ve gerekçeleri **[`PLAN.tr.md` §2](PLAN.tr.md)**'de, K1–K10 olarak numaralı.
...
Tek sahibi [`CLAUDE.tr.md`](CLAUDE.tr.md), "Kod konvansiyonları" başlığı — hata tipleri,
`async` sözleşmesi, newtype kimlikler, bağımlılık politikası ve isimlendirme dili
(D-073: tanımlayıcı da yazı da İngilizce; D-036'nın "yazı Türkçe"
kuralının yerini aldı).

Workspace ağacı ve komutlar da orada.

## Tanılama kültürü ve bağımlılıklar

Tek sahibi [`CLAUDE.tr.md`](CLAUDE.tr.md). Özü (K9): her başarısızlık **hangi aşamada**
