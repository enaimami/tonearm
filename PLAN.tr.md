...
> **Türkçe kopya.** Kanonik metin İngilizcedir: [`PLAN.md`](PLAN.md).
...
Bu üç başlığın tek sahibi [`CLAUDE.tr.md`](CLAUDE.tr.md)'dir; burada tekrarlanmaz.
...
Eklenti yazarı belgesi: `docs/writing-plugins.tr.md`.
...
önce yazıldı (`spike/tauri-gonogo/THRESHOLDS.tr.md`). Sekiz ölçünün sekizi de GO;
